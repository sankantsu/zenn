...
これらの設定が有効になった開発環境というのはエンジニア/開発者にとって我が家 (`$HOME`) のようなものであり、生産性の高い快適な開発体験を実現するために無くてはならないものです。
...
Dotfiles のリポジトリにも、自分用とはいえ使いかたなどを記した `README.md` を toplevel に置いておきたいです。
